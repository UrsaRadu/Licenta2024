...
<div class="container mt-5">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-outline w-50 m-auto mb-4">
                <label for="product_brands" class="form-label">
                        Product Brands
                    </label>
                ...
                <div class="form-outline w-50 m-auto mb-4">
                    ...
                    <img src="./product_images/limeta1.jpg" alt=""
                    class="product_img">
                    </div>    
                </div>
                <div class="form-outline w-50 m-auto mb-4">
                    ...
                    class="form-control w-90 m-auto" required="required">
                    <img src="./product_images/limeta2.jpeg" alt=""
                    class="product_img">
                    </div>    
                </div>
                <div class="form-outline w-50 m-auto mb-4">
                    ...
                    class="form-control w-90 m-auto" required="required">
                    <img src="./product_images/limeta3.jpg" alt=""
                    class="product_img">
                    </div>    
                </div>
                <div class="form-outline w-50 m-auto mb-4">
