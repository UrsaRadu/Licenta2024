<?php 
     ...
     if (isset($_POST['delete'])) {
      ...
      $p_id = filter_var($p_id, FILTER_SANITIZE_SPECIAL_CHARS); // FILTER_SANITIZE_STRING
    ...
    <?php include '../components/admin_header.php';  ?>
      ...
      <div class="main">
        ...
        ?>
          ...
          <form action="" method="post">
            ...
            <div class="status" style="color: <?php 
               if($fetch_product['status']=='active'){echo "green";
               }else{echo "red"; } ?>" > 
        ...
        <?php if($fetch_product['image'] != '' ){ ?>
            ...
            <div class="flex-btn">
              <a href="edit_product.php?id=<?= $fetch_product['id']; ?>" class="btn">
            edit </a>
            <button type="submit" name="delete" class="btn" 
            onclick="return confirm('delete this product');"> delete </button>
            <a href="view_product.php?id=<?= $get_id; ?>" class="btn">
            go back </a>
            </div>
          ...
          <?php  
                  ...
                  echo '
                        <div class="empty"> 
                          ...
                          style="margin-top: 1.5rem;" > add product </a></p>
                        </div>
                  ';
                } 
            ?>
