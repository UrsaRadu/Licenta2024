...
<form method="post" class="box">
    ...
    <div class="icon">
        ...
        onclick="return confirm ('do you want to delete this product from your wishlist')" ></a>
...
<div class="wishlist_total">
    ...
    <a href="shop.php">  </a> 
    <a href="wishlist.php?delete_all" class="btn2 <?php echo ($grand_total)?'':'disabled'?>" 
    onclick="return confirm ('do you want to delete all items')"></a>
</div>
